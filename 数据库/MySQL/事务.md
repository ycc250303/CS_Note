> 拆自 [黑马MySQL.md](./归档/黑马MySQL.md)（已归档，不再维护），原文未改。锁相关见 [锁.md](./锁.md)。事务原理拆自 [InnoDB引擎.md](./InnoDB引擎.md)。Read View / 隔离级别实现补自 [小林coding](https://www.xiaolincoding.com/mysql/transaction/mvcc.html)。幻读特例补自 [小林coding](https://www.xiaolincoding.com/mysql/transaction/phantom.html)。
